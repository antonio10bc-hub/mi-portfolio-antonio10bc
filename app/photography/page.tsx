  ...
  return (
    <main className="relative min-h-screen p-4 md:p-8 max-w-7xl mx-auto text-offblack bg-[#EAE8E0] flex flex-col overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute top-[30%] right-0 w-80 h-80 bg-gradient-to-r from-cyan-300/50 to-blue-300/50 rounded-full mix-blend-multiply filter blur-[70px] opacity-60"></div>
